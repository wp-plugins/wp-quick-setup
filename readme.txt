...
For more information, go to [screenshots](https://wordpress.org/plugins/wp-quick-setup/screenshots/).
...
1. Upload `wp-quick-setup.zip` to the `/wp-content/plugins/` directory
...
1. The quick install options
2. Front page, post page, read settings and timezone
3. Date and time format & create blank pages and categories
4. Install and activate popular plugins
5. Install plugins and themes from URL
