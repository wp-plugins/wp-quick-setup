...
1. Upload `WPQuickSetup` to the `/wp-content/plugins/` directory

2. Activate the plugin through the 'Plugins' menu in WordPress

3. Go to the plugin interface through Settings -> Quick Setup Settings

4. Choose your settings, and click “Quick Setup”
5. Enjoy saving these annoying minutes when you start up a new Wordpress blog!
